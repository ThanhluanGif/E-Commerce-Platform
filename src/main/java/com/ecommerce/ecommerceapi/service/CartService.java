...
public class CartService {
    ...
    public CartItem addItemToCart(Integer userId, Integer productId, Integer quantity) {
        ...
        if (product.getStockQuantity() < quantity) {
            throw new BadRequestException("Số lượng tồn kho không đủ (Hiện có: " + product.getStockQuantity() + ")!");
        }
        ...
        if (existingItemOpt.isPresent()) {
            ...
            if (product.getStockQuantity() < newQuantity) {
                throw new BadRequestException("Không thể thêm số lượng chỉ định. Tổng số lượng vượt quá tồn kho (Hiện có: " + product.getStockQuantity() + ")!");
            }
